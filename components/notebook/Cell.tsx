      ...
      <div className="flex items-center gap-2 border-b border-zinc-800 px-4 py-2">
        ...
        {cell.result && cell.status === "success" && (
          <span className="text-xs text-zinc-500">
            {cell.result.rowCount} rows · {cell.result.executionMs}ms
          </span>
        )}
        ...
        {cell.type === "result" && cell.result && (
          <div className="overflow-auto max-h-72">
            <table className="w-full text-xs">
              ...
              <tbody>
                {cell.result.rows.slice(0, 200).map((row, i) => (
            ...
            {cell.result.rowCount > 200 && (
              <p className="mt-2 text-center text-xs text-zinc-500">
                Showing 200 of {cell.result.rowCount} rows
              </p>
            )}
          </div>
        )}
